...
public class customlistview extends B4AClass.ImplB4AClass{
    private static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "personal.example.com.customlistview");
            if (htSubs == null) {
...
public String  _add(anywheresoftware.b4a.objects.PanelWrapper _pnl,int _itemheight,Object _value) throws Exception{
 //BA.debugLineNum = 155;BA.debugLine="Public Sub Add(Pnl As Panel, ItemHeight As Int, Value As Object)";
...
public String  _addtextitem(String _text,Object _value) throws Exception{
 //BA.debugLineNum = 84;BA.debugLine="Public Sub AddTextItem(Text As String, Value As Object)";
...
{
final double step35 = -1;
final double limit35 = (int)(0);
for (_i = (int)(_sv.getPanel().getNumberOfViews()-1); (step35 > 0 && _i <= limit35) || (step35 < 0 && _i >= limit35); _i += step35) {
...
_parent = (Object)(_v.getObject());
 //BA.debugLineNum = 187;BA.debugLine="Do While (parent Is Panel) = False OR sv.Panel <> parent";
...
if (true) return String.valueOf(_v.getTag());
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
int _idpressed = 0;
 //BA.debugLineNum = 17;BA.debugLine="Public Sub Initialize (vCallback As Object, vEventName As String)";
...
_callback = _vcallback;
 //BA.debugLineNum = 24;BA.debugLine="sv.Color = 0xFFD9D7DE 'this sets the dividers color";
...
_idpressed = 0;
 //BA.debugLineNum = 27;BA.debugLine="idPressed = r.GetStaticField(\"android.R$drawable\", \"list_selector_background\")";
...
_r.Target = _r.RunMethod("getResources");
 //BA.debugLineNum = 30;BA.debugLine="pressedDrawable = r.RunMethod2(\"getDrawable\", idPressed, \"java.lang.int\")";
...
int _i = 0;
 //BA.debugLineNum = 107;BA.debugLine="Public Sub InsertAt(Index As Int, Pnl As Panel, ItemHeight As Int, Value As Object)";
...
_top = 0;
 //BA.debugLineNum = 128;BA.debugLine="If Index = 0 Then top = dividerHeight Else top = sv.Panel.Height";
if (_index==0) { 
...
_previouspanel.setObject((android.view.ViewGroup)(_panels.Get((int)(_index-1))));
 //BA.debugLineNum = 137;BA.debugLine="top = previousPanel.top + previousPanel.Height + dividerHeight";
...
final double limit114 = (int)(_panels.getSize()-1);
for (_i = _index; (step114 > 0 && _i <= limit114) || (step114 < 0 && _i >= limit114); _i += step114) {
...
_sv.getPanel().AddView((android.view.View)(_p.getObject()),(int)(0),_top,_sv.getWidth(),_itemheight);
 ...
 //BA.debugLineNum = 150;BA.debugLine="sv.Panel.Height = sv.Panel.Height + ItemHeight + dividerHeight";
_sv.getPanel().setHeight((int)(_sv.getPanel().getHeight()+_itemheight+_dividerheight));
 //BA.debugLineNum = 151;BA.debugLine="If items.Size = 1 Then sv.Panel.Height = sv.Panel.Height + dividerHeight";
if (_items.getSize()==1) { 
...
int _minheight = 0;
 //BA.debugLineNum = 89;BA.debugLine="Public Sub InsertAtTextItem(Index As Int, Text As String, Value As Object)";
...
_lbl.Initialize(ba,"");
 //BA.debugLineNum = 94;BA.debugLine="lbl.Gravity = Bit.OR(Gravity.CENTER_VERTICAL, Gravity.LEFT)";
_lbl.setGravity(__c.Bit.Or(__c.Gravity.CENTER_VERTICAL,__c.Gravity.LEFT));
 //BA.debugLineNum = 95;BA.debugLine="pnl.AddView(lbl, 5dip, 2dip, sv.Width - 5dip, 20dip)";
...
_minheight = 0;
 //BA.debugLineNum = 101;BA.debugLine="minHeight = su.MeasureMultilineTextHeight(lbl, Text)";
...
{
final double step132 = 1;
final double limit132 = (int)(__c.Min(_index-1,_items.getSize()-1));
for (_i = (int)(0); (step132 > 0 && _i <= limit132) || (step132 < 0 && _i >= limit132); _i += step132) {
...
anywheresoftware.b4a.objects.ConcreteViewWrapper _v = null;
 ...
 //BA.debugLineNum = 175;BA.debugLine="If SubExists(CallBack, EventName & \"_ItemClick\") Then";
...
_v.setObject((android.view.View)(__c.Sender(ba)));
 //BA.debugLineNum = 178;BA.debugLine="CallSub3(CallBack, EventName & \"_ItemClick\", v.Tag, items.Get(v.Tag))";
__c.CallSub3(ba,_callback,_eventname+"_ItemClick",_v.getTag(),_items.Get((int)(BA.ObjectToNumber(_v.getTag()))));
 };
...
final double limit56 = (int)(_items.getSize()-1);
for (_i = (int)(_index+1); (step56 > 0 && _i <= limit56) || (step56 < 0 && _i >= limit56); _i += step56) {
 //BA.debugLineNum = 73;BA.debugLine="p = panels.Get(i)";
_p.setObject((android.view.ViewGroup)(_panels.Get(_i)));
 //BA.debugLineNum = 74;BA.debugLine="p.Tag = i - 1";
_p.setTag((Object)(_i-1));
 //BA.debugLineNum = 75;BA.debugLine="p.Top = p.Top - removePanel.Height - dividerHeight";
_p.setTop((int)(_p.getTop()-_removepanel.getHeight()-_dividerheight));
 }
};
 //BA.debugLineNum = 77;BA.debugLine="sv.Panel.Height = sv.Panel.Height - removePanel.Height - dividerHeight";
